...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Add = channel.unary_unary(
                ...
                response_deserializer=calc__pb2.CalcResponse.FromString,
                )
        ...
        self.Divide = channel.unary_unary(
                ...
                request_serializer=calc__pb2.CalcRequest.SerializeToString,
                response_deserializer=calc__pb2.DivResponse.FromString,
                )
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Add': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=calc__pb2.CalcResponse.SerializeToString,
            ),
            ...
            'Divide': grpc.unary_unary_rpc_method_handler(
                    servicer.Divide,
                    request_deserializer=calc__pb2.CalcRequest.FromString,
                    response_serializer=calc__pb2.DivResponse.SerializeToString,
            ),
    }
...
class Calculator(object):
    ...
    def Add(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/calc.Calculator/Add',
            ...
            calc__pb2.CalcResponse.FromString,
    ...
    def Divide(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/calc.Calculator/Divide',
            calc__pb2.CalcRequest.SerializeToString,
            calc__pb2.DivResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
